 ...
 * 
 *         Vue console d'un jeu d'échec Cette classe est un observateur et le
 *         damier est mis à jour à chaque changement dans la classe métier
 */
...
public class ChessGameCmdLine implements Observer {
	 ...
	 * 
	 * Lorsque l'échiquier est MAJ, cette méthode est invoquée elle
	 * récupère la liste de PieceIHM fabriquée par l'échiquier
	 */
	@Override
